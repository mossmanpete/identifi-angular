...
$templateCache.put('app/main/login.modal.html','<div class="col-md-8 col-md-offset-2"><div class="panel panel-default mar-top15"><div class=panel-heading><textarea class=form-control placeholder="Enter private key" ng-model=privateKeyPEM></textarea><div class=checkbox><label><input type=checkbox checked> Remember me</label></div><button class="btn btn-primary" ng-click=generateKey()>Generate new key</button> <button class="btn btn-primary" ng-click="loginWithKey(privateKeyPEM, publicKeyPEM)">Log in</button></div></div></div>');
